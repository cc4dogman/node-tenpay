  ...
  constructor(
    ...
    this.urls = sandbox
      ? {
          ...
          reverse:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/secapi/pay/reverse",
          unifiedorder:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/pay/unifiedorder",
          orderquery:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/pay/orderquery",
          closeorder:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/pay/closeorder",
          refund:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/secapi/pay/refund",
          refundquery:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/pay/refundquery",
          downloadbill:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/pay/downloadbill",
          downloadfundflow:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/pay/downloadfundflow",
          send_coupon:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/send_coupon",
          query_coupon_stock:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/query_coupon_stock",
          querycouponsinfo:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/querycouponsinfo",
          transfers:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/promotion/transfers",
          gettransferinfo:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/gettransferinfo",
          sendredpack:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/sendredpack",
          sendgroupredpack:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/sendgroupredpack",
          gethbinfo:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaymkttransfers/gethbinfo",
          paybank:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaysptrans/pay_bank",
          querybank:
            "https://api.mch.weixin.qq.com/xdc/apiv2sandbox/mmpaysptrans/query_bank",
        }
      : {
  ...
  middleware(type = "pay") {
    return async (ctx, next) => {
      ...
      try {
        ...
        ctx.request.weixin = await this._parse(
          ctx.request.body,
          "middleware_" + type
        );
      } catch (err) {
